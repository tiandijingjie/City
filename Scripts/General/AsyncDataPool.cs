...
/// <summary>
/// 高性能异步数据池 (基于双缓冲与 Swap-And-Pop 算法)
/// 允许任何线程无阻塞地投递增删请求，并在主线程安全地遍历与合并。
/// 使用了交换删除的方式，所以必须存储不关心存储顺序的数据 ！！！
/// </summary>
public class AsyncDataPool<Ttype> : IDisposable
{
...
#region public functions
    ...
    public AsyncDataPool(int capacity = 16)
    {
