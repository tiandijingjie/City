...
namespace WarField
{
    ...
    //晕眩
    public class CardMeleeSwordsmanSkillStun : CardEffection<CardMeleeSwordsmanSkillStun>
    {
        public CardMeleeSwordsmanSkillStun()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (SwordsmanIndividualData.IndividualDataType.STUN, (object)null), false);
