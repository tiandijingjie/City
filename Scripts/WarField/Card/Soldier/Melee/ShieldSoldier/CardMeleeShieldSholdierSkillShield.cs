...
namespace WarField
{
    ...
    //护盾
    public class CardMeleeShieldSholdierSkillShield : CardEffection<CardMeleeShieldSholdierSkillShield>
    {
        public CardMeleeShieldSholdierSkillShield()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (ShieldSoldierIndividualData.IndividualDataType.SHIELD, (object)null), false);
