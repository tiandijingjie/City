...
namespace WarField
{
    ...
    //暗杀技能
    public class CardMeleeAssassinSkillAssassinate : CardEffection<CardMeleeAssassinSkillAssassinate>
    {
        public CardMeleeAssassinSkillAssassinate()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (AssassinIndividualData.IndividualDataType.ASSASSINATE, (object)null), false);
