...
namespace WarField
{
    ...
    //暴击技能
    public class CardMeleeAssassinSkillCrit : CardEffection<CardMeleeAssassinSkillCrit>
    {
        public CardMeleeAssassinSkillCrit()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (AssassinIndividualData.IndividualDataType.CRIT, (object)null), false);
