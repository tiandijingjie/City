...
namespace WarField
{
    ...
    //连击
    public class CardRangedSharpSholdierSkillBarrage : CardEffection<CardRangedSharpSholdierSkillBarrage>
    {
        public CardRangedSharpSholdierSkillBarrage()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (SharpShooterIndividualData.IndividualDataType.BARRAGE, (object)null), false);
