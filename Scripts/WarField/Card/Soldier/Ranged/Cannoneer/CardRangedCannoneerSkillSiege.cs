...
namespace WarField
{
    ...
    //攻城
    public class CardRangedCannoneerSkillSiege : CardEffection<CardRangedCannoneerSkillSiege>
    {
        public CardRangedCannoneerSkillSiege()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (CannoneerIndividualData.IndividualDataType.SIEGE, (object)null), false);
