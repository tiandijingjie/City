...
namespace WarField
{
    ...
    //流血
    public class CardRangedCannoneerSkillBleeding : CardEffection<CardRangedCannoneerSkillBleeding>
    {
        public CardRangedCannoneerSkillBleeding()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (CannoneerIndividualData.IndividualDataType.BLEEDING, (object)null), false);
