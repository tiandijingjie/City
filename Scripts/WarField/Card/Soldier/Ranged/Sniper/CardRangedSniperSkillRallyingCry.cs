...
namespace WarField
{
    ...
    //凝聚人心
    public class CardRangedSniperSkillRallyingCry : CardEffection<CardRangedSniperSkillRallyingCry>
    {
        public CardRangedSniperSkillRallyingCry()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (SniperIndividualData.IndividualDataType.RALLYINGCRY, (object)null), false);
