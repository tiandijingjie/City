...
namespace WarField
{
    ...
    //
    public class CardSupportPriestSkillRejuvenation : CardEffection<CardSupportPriestSkillRejuvenation>
    {
        public CardSupportPriestSkillRejuvenation()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (PriestIndividualData.IndividualDataType.REJUVENATION, (object)null), false);
