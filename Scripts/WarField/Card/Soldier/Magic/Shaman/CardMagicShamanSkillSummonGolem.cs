...
namespace WarField
{
    ...
    //召唤石人
    public class CardSupportShamanSkillSummonGolem : CardEffection<CardSupportShamanSkillSummonGolem>
    {
        public CardSupportShamanSkillSummonGolem()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (ShamanIndividualData.IndividualDataType.SUMMONGOLEM, (object)null), false);
