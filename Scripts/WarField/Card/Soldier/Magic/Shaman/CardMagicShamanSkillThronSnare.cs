...
namespace WarField
{
    ...
    //荆棘术
    public class CardSupportShamanSkillThronSnare : CardEffection<CardSupportShamanSkillThronSnare>
    {
        public CardSupportShamanSkillThronSnare()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            bool improveRet = SoldierCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, SD.SoldierImproveTarget.SKILL,
                ...
                (ShamanIndividualData.IndividualDataType.THRONSNARE, (object)null), false);
