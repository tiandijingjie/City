...
namespace WarField
{
    ...
    public class CardRangedBarrackDoubleSpawn : CardEffection<CardRangedBarrackDoubleSpawn>
    {
        public CardRangedBarrackDoubleSpawn()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            ...
            bool improveRet = WarBuildingCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, WE.RaceType.Human, WBD.BuildingMode.BARRACK, (int)
                HumanDefines.BarrackType.RANGED, "doubleChance", value, GD.CalDeltaType.ADD);
            if (improveRet == false)
            {
