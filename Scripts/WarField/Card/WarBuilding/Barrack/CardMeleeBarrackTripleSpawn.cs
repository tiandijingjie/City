...
namespace WarField
{
    ...
    public class CardMeleeBarrackTripleSpawn : CardEffection<CardMeleeBarrackTripleSpawn>
    {
        private BarrackConf _conf;
        public CardMeleeBarrackTripleSpawn()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            ...
            bool improveRet = WarBuildingCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, WE.RaceType.Human, WBD.BuildingMode.BARRACK, (int)
                HumanDefines.BarrackType.MELEE, "tripleChance", value, GD.CalDeltaType.ADD);
            if (improveRet == false)
            {
