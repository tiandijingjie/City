...
namespace WarField
{
    ...
    public class CardMeleeBarrackDoubleSpawn : CardEffection<CardMeleeBarrackDoubleSpawn>
    {
        public CardMeleeBarrackDoubleSpawn()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            ...
            bool improveRet = WarBuildingCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, WE.RaceType.Human, WBD.BuildingMode.BARRACK, (int)
                HumanDefines.BarrackType.MELEE, "doubleChance", value, GD.CalDeltaType.ADD);
            if (improveRet == false)
            {
