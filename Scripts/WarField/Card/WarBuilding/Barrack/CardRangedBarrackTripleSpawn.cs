...
namespace WarField
{
    ...
    public class CardRangedBarrackTripleSpawn : CardEffection<CardRangedBarrackTripleSpawn>
    {
        private BarrackConf _conf;
        public CardRangedBarrackTripleSpawn()
        {
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            ...
            bool improveRet = WarBuildingCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, WE.RaceType.Human, WBD.BuildingMode.BARRACK, (int)
                HumanDefines.BarrackType.RANGED, "tripleChance", value, GD.CalDeltaType.ADD);
            if (improveRet == false)
            {
