...
namespace WarField
{
    ...
    public class CardMeleeBarrackQuadrupleSpawn : CardEffection<CardMeleeBarrackQuadrupleSpawn>
    {
        private BarrackConf _conf;
        public CardMeleeBarrackQuadrupleSpawn()
        {
        ...
        public override bool CanBeInit()
        {
            if (_conf == null)
                _conf = (BarrackConf)WarBuildingCtrl.Instance.GetBdConf(WE.RaceType.Human, WBD.BuildingMode.BARRACK,
                    (int)HumanDefines.BarrackType.MELEE);
        ...
        protected override bool OnTakeEffect(CardDefines.CardLevel level)
        {
            ...
            bool improveRet = WarBuildingCtrl.Instance.ApplyImprovement(WE.ImproveSrc.FROMCARD, WE.RaceType.Human, WBD.BuildingMode.BARRACK, (int)
                HumanDefines.BarrackType.MELEE, "quadrupleChance", value, GD.CalDeltaType.ADD);
            if (improveRet == false)
            {
