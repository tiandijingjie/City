...
namespace WarField
{
    ...
    public class NeutralMelee : NeutralSoldier
    {
...
#region private parameters
        ...
        [SerializeField] protected NeutralDefines.MeleeType _sdType;
...
#region public functions
        ...
        public override bool InitSoldier(WE.FactionType faction, byte mapId)
        {
